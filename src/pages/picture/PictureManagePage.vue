...
import { deletePictureUsingPost, listPagePictureUsingPost, reviewPictureUsingPost } from '@/api/pictureController'
...
// 数据
const dataList = ref<API.ListPagePictureVO[]>([])
const total = ref(0)

const picture = ref<API.PictureVO>({})

// 搜索条件
const searchParams = reactive<API.ListPagePictureQO>({
  pageNum: 1,
  pageSize: 10,
  searchText: ''
})
...
const handleReview = async (record: API.PictureDO, reviewStatus: number) => {
