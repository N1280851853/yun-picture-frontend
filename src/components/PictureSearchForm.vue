...
interface Props {
  onSearch?: (searchParams: API.ListPagePictureQO) => void
}
...
const onRangeChange = (dates: any[], dateStrings: string[]) => {
  if (dates?.length >= 2) {
    searchParams.startUploadTime = dates[0].toDate()
    searchParams.endUploadTime = dates[1].toDate()
  } else {
    searchParams.startUploadTime = undefined
    searchParams.endUploadTime = undefined
  }
}
